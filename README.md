...
- 🔌 **Disparadores Automáticos Nativos (Segundo Plano)**: Inicia cualquier atajo automáticamente cuando conectas o desconectas el celular de la corriente (`ACTION_POWER_CONNECTED` / `ACTION_POWER_DISCONNECTED`), configurado limpiamente dentro del editor de cada atajo sin pestañas innecesarias.
